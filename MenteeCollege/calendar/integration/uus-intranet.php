...
function setLogin($chkLogin,$username,$password) {
	...
	setcookie($cookie_prefix."bdUserID",$cookieData,time() + 604800);
	}
...
function clearLogin() {
	...
	setcookie($cookie_prefix."bdUserID","",time() - 604800);
	setcookie($cookie_prefix."myDates","",time()-86400);
	}
...
function createAccount($username,$email,$password) {
	...
	$result = query("INSERT INTO bosdevUUS (username,password,email,status,bd1) VALUES ('$username','$password','$email',0,1)",$uus_link);
