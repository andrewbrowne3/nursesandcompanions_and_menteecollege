...
<table width="90%" border="0" cellspacing="1" cellpadding="3">
 <tr>
  <td valign="top" width="200">
   <a href="{$insUrl}admin/index.php?action=system">{$Languages['admin']['menusystem']}</a><br>
   <br>
   <a href="{$insUrl}admin/index.php?action=events">{$Languages['admin']['menuevents']}</a><br>
   <br>
   <a href="{$insUrl}admin/index.php?action=stylesheets">{$Languages['admin']['menustyle']}</a><br>
   <br>
   <a href="{$insUrl}admin/index.php?action=users">{$Languages['admin']['menuusers']}</a><br>
   <br>
   <a href="{$insUrl}admin/index.php?action=database">{$Languages['admin']['menudatabase']}</a><br>
   <br>
   <br>
